...
{
	   uint8_t sr1 = I2C_SR1; // Read status register 1
    uint8_t sr2 = I2C_SR3; // Read status register 3 (clears ADDR flag)

    if (sr1 & I2C_SR1_ADDR) {
        // Address matched
        (void)sr2; // Clear ADDR flag by reading SR3
    } else if (sr1 & I2C_SR1_RXNE) {
        // Byte received
        received_data = I2C_DR;
    } else if (sr1 & I2C_SR1_TXE) {
        // Byte transmitted, ready for next byte
        I2C_DR = data_to_send;
    } else if (sr1 & I2C_SR1_STOPF) {
        // Stop condition detected
        I2C_CR2 |= I2C_CR2_ACK; // Clear STOPF flag and re-enable ACK
    }
}
